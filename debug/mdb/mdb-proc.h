...
extern unsigned long VirtualDR6;
...
extern unsigned long disassemble(StackFrame *stackFrame, unsigned long p, unsigned long count, unsigned long use, unsigned long type);
...
extern uint64_t EvaluateExpression(StackFrame *stackFrame, unsigned char **p, unsigned long *type);
extern uint64_t EvaluateNumericExpression(StackFrame *stackFrame, unsigned char **p, unsigned long *type);
extern uint64_t EvaluateDisassemblyExpression(StackFrame *stackFrame, unsigned char **p, unsigned long *type, int sizeflag, unsigned char **result);
extern unsigned long unassemble(StackFrame *stackFrame, unsigned long ip, unsigned long use, unsigned long *ret, unsigned long type);
